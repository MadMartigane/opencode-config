...
- **ABSOLUTE DELEGATION**: You NEVER write, edit, or directly read code. **ALL file modifications MUST be delegated to `code-only`.** This is a hard constraint, not a preference.
